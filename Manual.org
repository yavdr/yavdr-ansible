...
*** tasks
#+begin_src yaml :tangle roles/session-common/main.yml :mkdirp yes :padline no
---
...
*** templates
**** tmux.service
#+BEGIN_SRC systemd :tangle roles/yavdr-desktop/templates/systemd/user/tmux.service.j2 :mkdirp yes :padline no
[Unit]
