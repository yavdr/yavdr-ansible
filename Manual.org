...
- name: set up yaVDR
  ...
  roles:
    ...
    #- channellogos-de            # use channellogos provided by https://github.com/Jasmeet181/mediaportal-de-logos 
...
*** tasks
#+BEGIN_SRC yaml :tangle roles/channellogos-de/tasks/main.yml :padline no
...
*** templaces
#+BEGIN_SRC python :tangle roles/channellogos-de/templates/channel_linker.py.j2 :padline no :shebang "#!/usr/bin/env python3"
{{ ansible_managed | comment }}
import shutil
