...
TODO: To allow transfer of sensitive data (e.g. for login), the nginx server should use a SSL certificate. It makes sense to configure vdr-plugin-live-ng to use it, too.

By default the playbook should generate a self-signed certificate if the user doesn't give the playbook a certificate to use for this.
